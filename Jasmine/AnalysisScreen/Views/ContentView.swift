                        ...
                        VStack(spacing: 16) {
                            ...
                            if vm.isLoading {
                                VStack(spacing: 12) {
                                    ...
                                    Text("""
                            ⚠️ Disclaimer:
                            This analysis is generated by an experimental AI model and may not be 100% accurate.
                            Do not rely on this result for medical decisions. Always consult a qualified dermatologist.
